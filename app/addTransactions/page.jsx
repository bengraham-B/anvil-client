    ...
    return (
        <main className='flex w-full justify-center align-middle flex-col px-4 my-4 space-y-4'>
            ...
            <section id="header" className='flex w-full justify-center py-2'>
                <h1 className='xsm:text-2xl text-3xl'>Insert Transaction</h1>
            </section>


            <section id="input-container" className='flex flex-row xsm:flex-col lg:flex-row justify-around align-middle py-2'>

                <span className='flex flex-row  space-x-2 align-middle justify-center mx-1'>
                    <h4 className='flex xsm:w-1/4 items-center text-lg text-center'>Details</h4>
                    <input type="text" onChange={(e) => setDetails(e.target.value)} className='border border-black rounded-sm pl-2 w-3/4'/>
                </span>
               
                <span className='flex flex-row space-x-2 mx-1'>
                    <h4 className='flex xsm:w-1/4  items-center  text-lg'>Amount</h4>
                    <input type="number" onChange={(e) => setAmount(e.target.value)} className='border border-black rounded-sm pl-2  w-3/4'/>
                </span>
               
                <span className='flex flex-row space-x-2 mx-1 '>
                    <h4 className='flex items-center xsm:w-1/4  text-lg'>Category</h4>
                ...
                <span className='flex flex-row space-x-2 mx-1'>
                    <h4 className='flex items-center xsm:w-1/4  text-lg'>Class</h4>
                    <input type="text" onChange={(e) => setClass_(e.target.value)} className='border border-black rounded-sm pl-2  w-3/4'/>
                </span>
               
                <span className='flex flex-row space-x-2 mx-1'>
                    <h4 className='flex xsm:w-1/4  items-center  text-lg'>Date</h4>
